...
var scrollVis = function () {
  ...
  //     .attr('opacity', 0);
    ...
    //BIOPHILIC_TRAIL
    g.append('svg:image')
      .attr('class', 'title BIOPHILIC_DESIGN_TRAIL_STATION-01')
      .attr('x', width / 8)
      .attr('y', 0)
      .attr("width", width/1.3)
      .attr("height", height/1.3)
      .attr("xlink:href", "images/BIOPHILIC_TRAIL/BIOPHILIC_DESIGN_TRAIL_STATION-01.jpg");

    g.selectAll('.BIOPHILIC_DESIGN_TRAIL_STATION-01')
      .attr('opacity', 0);

    //NATURE_IN_PLACE
    g.append('svg:image')
      .attr('class', 'title NATURE_IN_PLACE_1')
      .attr('x', width / 8)
      .attr('y', 0)
      .attr("width", width/1.3)
      .attr("height", height/1.3)
      .attr("xlink:href", "images/BIOPHILIC_TRAIL/NATURE_IN_PLACE_1.jpg");

    g.selectAll('.NATURE_IN_PLACE_1')
      .attr('opacity', 0);


    //NATURE_OF_PLACE
    g.append('gif:image')
      .attr('class', ' title NATURE_OF_PLACE_1')
      .attr('x', width / 8)
      .attr('y', 0)
      .attr("width", width/1.3)
      .attr("height", height/1.3)
      .attr("xlink:href", "images/BIOPHILIC_TRAIL/NATURE_OF_PLACE_1.jpg");

    g.selectAll('.NATURE_OF_PLACE_1')
      .attr('opacity', 0);


    //MATERIALITY
    g.append('svg:image')
      .attr('class', 'title MATERIALITY_1')
      .attr('x', width / 8)
      .attr('y', 0)
      .attr("width", width/1.3)
      .attr("height", height/1.3)
      .attr("xlink:href", "images/BIOPHILIC_TRAIL/MATERIALITY_1.jpg");

    g.selectAll('.MATERIALITY_1')
      .attr('opacity', 0);


    //BIOPHILIC_PROFILING
    g.append('svg:image')
      .attr('class', 'title BIOPHILIC_PROFILING_1')
      .attr('x', width / 8)
      .attr('y', 0)
      .attr("width", width/1.3)
      .attr("height", height/1.3)
      .attr("xlink:href", "images/BIOPHILIC_TRAIL/BIOPHILIC_PROFILING_1.jpg");

    g.selectAll('.BIOPHILIC_PROFILING_1')
      .attr('opacity', 0);
